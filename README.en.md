...
```
src/
├── main.py                    # Entry point (CLI, AgentCore Runtime)
├── cli.py                     # CLI interface
│
├── task_manager/              # Centralized task management
│   ├── types.py               # Task, TaskResult, TaskStatus, WorkflowProgress
│   └── manager.py             # TaskManager singleton
│
├── agents/
│   ├── analyzer.py            # Workshop structure analysis (Haiku)
│   ├── designer.py            # Design document generation (Sonnet)
│   ├── orchestrator.py        # Orchestrator tools
│   └── workers/               # Stateless workers
│       ├── translator_worker.py  # Translation worker (Sonnet)
│       ├── reviewer_worker.py    # Review worker (Sonnet + MCP)
│       └── validator_worker.py   # Validation worker
│
├── mcp_client/                # MCP client
│   └── client.py              # AWS Documentation MCP integration
│
├── model/                     # Model loading
│   └── load.py                # Opus, Sonnet, Haiku loaders
│
├── prompts/                   # System prompts
│   └── system_prompts.py      # Per-agent prompts
│
└── tools/                     # File tools
    └── file_tools.py          # Workshop file read/write
```
